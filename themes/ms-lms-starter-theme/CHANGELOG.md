## 2.1.1 - 2026-03-25
- **FIXED**: Fixed an error when changing theme colors via WordPress Customizer

## 2.1.0 - 2026-03-18
- **NEW**: Added new template – Creators  
- **NEW**: Premium MasterStudy Templates users can now access the Custom Course Pages feature. Use it to build unique, conversion-focused course pages with 50+ Elementor widgets.

## 2.0.13 - 2026-03-09
- **FIXED**: Resolved an issue where changing theme colors via WordPress Customizer caused an error.
