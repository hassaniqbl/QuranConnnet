...
== Changelog ==
= 3.29.9 - 09-07-2026 =
 * Changed character limit color scheme to use percentage of the limit reached instead of a fixed character count
 * Added option to always use default color for character limit message
 * Fixed "Show Remaining Characters" setting appearing twice on Text Area fields
 * Fixed Gallery field hiding uploaded images from the media library

= 3.29.8 - 08-07-2026 =
 * Added character count feature to all text fields

= 3.29.7 - 06-07-2026 =
 * Added special permissions options
 * Fixed Product Status field

= 3.29.6 - 18-06-2026 =
 * Fixed permissions showing when user can view form

= 3.29.5 - 17-06-2026 =
 * Fixed error when non admins submit forms in Gutenberg and Bricks 

= 3.29.4 - 10-06-2026 =
 * Fixed Multi Step forms

= 3.29.3 - 07-05-2026 =
 * Fixed error in cpt edit page
 * Fixed multiple select field conditional logic issue
...
= 3.28.34 - 10-04-2026 =
 * Fixed clash with ACF field group admin gui

= 3.28.33 - 01-04-2026 =
 * Fixed post content issue
