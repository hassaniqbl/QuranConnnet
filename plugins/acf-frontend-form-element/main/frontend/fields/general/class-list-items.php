	...
	class list_items extends Field_Base {
		...
		*/
		...
		function render_field_settings( $field ) {
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Show Order', 'acf' ),
					'instructions' => '',
					'type'         => 'radio',
					'name'         => 'show_order',
					'layout'       => 'horizontal',
					'choices'      => array(
						'numbers' => __( 'Numbers', 'acf' ),
						'ids'     => __( 'IDs', 'acf' ),
						'no'      => __( 'No', 'acf' ),
					),
				)
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Add Button Locations', 'acf' ),
					'instructions' => '',
					'type'         => 'checkbox',
			...
			acf_render_field_setting(
				$field,
				array(
					'label'        => __( 'Show Remove Button', 'acf' ),
					'instructions' => '',
					'type'         => 'true_false',
					'name'         => 'show_remove',
					'ui'           => 1,
		...
		*/
		...
		function render_field( $field ) {
			...
			$show_order  = $field['show_order'] ?? 'numbers';

			$show_add    = $field['show_add'] ?? true;
			$show_remove = $field['show_remove'] ?? true;

			$add_button_locations = $field['add_button_locations'] ?? array( 'top', 'bottom', 'rows' );
